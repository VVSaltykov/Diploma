...
public class AchievementsController : BotController
{ 
    ...
    public AchievementsController(IInlineButtonsGenerationService buttonsGenerationService, IKeyboardButtonsGenerationService keyboardButtonsGenerationService)
    {
        _buttonsGenerationService = buttonsGenerationService;
        _keyboardButtonsGenerationService = keyboardButtonsGenerationService;
    }
    
    [Message("Достижения учеников", MessageType.Text, ignoreCase: true)]
    public async Task SendMessages()
    {
        IAchievementsService achievementsService = SingletonService.GetAchievementsService();
        
        var achievements = await achievementsService.GetAll();
        ...
        {
            await Client.SendTextMessageAsync(Update.GetChatId(), "Никто еще не заслужил достижение.");
        }
    }

    [Callback("previousAchievements", ignoreCase: true)]
    ...
    [Callback("nextAchievements", ignoreCase: true)]
    ...
    [Callback("tohomeAchievements", ignoreCase: true)]
